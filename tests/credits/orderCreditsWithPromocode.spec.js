...
test('Order credits with promocode', async ({ page }) => {
  ...
  await credits.orderWithPromocode(testData.credits.reportType, testData.credits.promoCode, testData.credits.card);
